...
public class Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        googleLoginBtn = findViewById(R.id.tvLogin); // Sekarang ImageView
        ...
        // Aksi klik tombol Google Login (ImageView)
        ...
        // Aksi klik tombol login email/password
                ...
                .addOnCompleteListener(Login.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            finish();
                            Toast.makeText(Login.this, "Selamat Datang " + user.getEmail(), Toast.LENGTH_SHORT).show();
                        } else {
    ...
    // Menangani hasil login dari Google
    @Override
